...
public:
	...
	bool WriteToFile(std::string filename,Coordinate home,Coordinate Takeoff,Coordinate landway, Coordinate takeoffWay, double alt, double turnDist, double Space, double Camera);
private:
